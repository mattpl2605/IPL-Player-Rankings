...
url = 'https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/107-mostwickets.js?callback=onmostwickets&_=1703266840031'
...
converted_df.to_csv("bowlers-ipl-2023.csv", index=False)
